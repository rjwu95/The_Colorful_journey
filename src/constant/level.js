...
export const level = [
  ...
  },
  {
    ...
    map: [
      ...
      {x: 19, y: 51, w:13, h: 2},
      {x: 4, y: 45, w:12, h: 2},
      {x: 8, y: 40, w:8, h: 5, color: 'rgb(200, 150, 0)'},
      {x: 17, y: 34, w:8, h: 5, color: 'rgb(200, 150, 0)'},
      {x: 49, y: 51, w:14, h: 2},
      {x: 63, y: 45, w:2, h: 20},
      {x: 17, y: 39, w:12, h: 2},
      {x: 4, y: 33, w:12, h: 2},
      ...
      {x: 100, y: 37, w:12, h: 3},
      {x: 49, y: 33, w:3, h: 12},
      {x: 91, y: 34, w:3, h: 10, color: 'rgb(70, 200, 70)'},
      {x: 52, y: 43, w:13, h: 2},
      {x: 65, y: 43, w:13, h: 2, color: 'rgb(220, 200, 170)'},
      {x: 78, y: 43, w:16, h: 2},
      {x: COLUMNS * 2 - 30, y: 49, w: 30, h: 2},
      {x: COLUMNS * 2 - 30, y: 51, w: 2, h: 6, color: 'rgb(220, 200, 170)'},
    ],
    startPoint: {x: 5, y: ROWS * 2 - 15},
    portal: {x: COLUMNS * 2 - 10, y: ROWS * 2 - 11, color: 'pink'},
    items: [
      {x: COLUMNS * 2 - 8, y: ROWS * 2 - 17, color: {r: 70, g: 200, b: 70}},
      {x: 55, y: 40, color: {r: 150, g: 0, b: 100}}, //1
      {x: 60, y: 48, color: {r: 200, g: 150, b: 0}},
      {x: 6, y: 42, color: {r: 0, g: 10, b: 200}},
      {x: 23, y: 25, color: {...BACKGROUND_COLOR}},
      {x:30, y: 19, color: { r: 0, g: 200, b: 0}},
      {x: 34, y: 24, color: {...BACKGROUND_COLOR}},
      {x:75, y: 24, color: { r: 100, g: 0, b: 200}},
    ...
    obstacles: [
      {x:78.5, y: 15, color: 'rgb(100, 200, 200)'},
    ],
  },
  {
    ...
    items: [
      ...
      {x: 97, y: 56, color: {r: 255, g: 0, b: 0}},
      {x: 101, y: 56, color: {r:0, g: 255, b: 0}},

      {x: 76, y: 40, color: {r:0, g: 0, b: 255}},
